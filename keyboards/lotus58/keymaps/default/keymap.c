...
[_NUM] = LAYOUT(
_______,	XXXXXXX,	XXXXXXX,	KC_LBRC, 	KC_RBRC, 	XXXXXXX, 	_______, 	_______,	KC_BSPC, 	KC_CALC, 	KC_ASTR, 	KC_PSLS, 	XXXXXXX, 	XXXXXXX,
_______,	XXXXXXX,	XXXXXXX, 	KC_LPRN, 	KC_RPRN, 	XXXXXXX,                         	KC_PMNS,    KC_KP_7,    KC_KP_8,    KC_KP_9, 	XXXXXXX, 	XXXXXXX,
_______,	XXXXXXX, 	XXXXXXX, 	KC_LCBR, 	KC_RCBR, 	KC_RBRC,                         	KC_PPLS,    KC_KP_4,    KC_KP_5,    KC_KP_6, 	KC_KP_0, 	XXXXXXX,
_______,	XXXXXXX,	XXXXXXX, 	KC_LT, 		KC_GT,  	XXXXXXX, 	_______, 	_______,  	KC_KP_DOT,	KC_KP_1, 	KC_KP_2,    KC_KP_3, 	XXXXXXX, 	_______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    [_QWERTY] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_L, KC_WH_R) },
